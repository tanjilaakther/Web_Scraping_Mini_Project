...
class SeMpcbTesysGv2Spider(scrapy.Spider):
    name = 'se_mpcb_TeSys_GV2'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[26]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[27]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[28]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[29]/td/div/text())").get()
            yield {
