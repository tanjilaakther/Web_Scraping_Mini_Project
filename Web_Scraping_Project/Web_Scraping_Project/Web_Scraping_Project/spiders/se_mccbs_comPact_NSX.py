...
class SeMccbsCompactNsxSpider(scrapy.Spider):
    name = 'se_mccbs_comPact_NSX'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[22]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[21]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[23]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[24]/td/div/text())").get()
            yield {
