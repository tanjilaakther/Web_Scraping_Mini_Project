...
class SeSdfMasterpactSdSpider(scrapy.Spider):
    name = 'se_sdf_masterPact_sd'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[7]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[8]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[9]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[10]/td/div/text())").get()
            yield {
