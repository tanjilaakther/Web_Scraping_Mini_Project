...
class SeMpcbTesysGv4Spider(scrapy.Spider):
    name = 'se_mpcb_TeSys_GV4'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_width = n.xpath("normalize-space(.//tr[15]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[17]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[18]/td/div/text())").get()
            yield {
