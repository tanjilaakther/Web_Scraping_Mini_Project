...
class AbbMcbS200MtRangeSpider(scrapy.Spider):
    name = 'abb_mcb_s200-mt-range'
    #allowed_domains = ['www.abb.com']
    #start_urls = ['http://www.abb.com/']
    ...
    def parse(self, response):
        ...
        characteristics = response.xpath(
            "//div[@id='Content_C004_Col00']/div/div[3]/div[2]/div/div/div[1]/div/div/div[3]/div[4]/ul")


        for n in characteristics:
            product_name = response.xpath("normalize-space(//h2[@class='pdp-product-info__description']/text())").get()
            product_height = n.xpath("normalize-space(.//li[3]/dl/dd/text())").get()
            product_width = n.xpath("normalize-space(.//li[1]/dl/dd/text())").get()
            product_depth = n.xpath("normalize-space(.//li[2]/dl/dd/text())").get()
            product_weight = n.xpath("normalize-space(.//li[4]/dl/dd/text())").get()
            yield {
