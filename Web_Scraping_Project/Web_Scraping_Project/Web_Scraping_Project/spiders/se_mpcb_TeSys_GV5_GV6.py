...
class SeMpcbTesysGv5Gv6Spider(scrapy.Spider):
    name = 'se_mpcb_TeSys_GV5_GV6'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[11]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[10]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[12]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[13]/td/div/text())").get()
            yield {
