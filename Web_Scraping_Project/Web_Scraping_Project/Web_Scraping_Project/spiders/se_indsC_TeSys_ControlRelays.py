...
class SeIndscTesysControlrelaysSpider(scrapy.Spider):
    name = 'se_indsC_TeSys_ControlRelays'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[19]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[20]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[21]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[22]/td/div/text())").get()
            yield {
