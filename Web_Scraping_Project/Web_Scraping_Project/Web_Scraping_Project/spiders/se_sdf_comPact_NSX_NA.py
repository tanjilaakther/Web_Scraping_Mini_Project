...
class SeSdfCompactNsxNaSpider(scrapy.Spider):
    name = 'se_sdf_comPact_NSX_NA'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[10]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[11]/td/div/text())").get()
