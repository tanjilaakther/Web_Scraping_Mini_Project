...
class SeSdfCompactNsNaSpider(scrapy.Spider):
    name = 'se_sdf_comPact_NS_NA'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_width = n.xpath("normalize-space(.//tr[18]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[19]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[20]/td/div/text())").get()
            yield {
