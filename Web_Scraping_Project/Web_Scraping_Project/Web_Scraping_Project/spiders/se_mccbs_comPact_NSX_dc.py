...
class SeMccbsCompactNsxDcSpider(scrapy.Spider):
    name = 'se_mccbs_comPact_NSX_dc'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[17]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[16]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[18]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[19]/td/div/text())").get()
            yield {
