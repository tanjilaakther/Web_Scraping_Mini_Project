...
class SeIndscTesysKSpider(scrapy.Spider):
    name = 'se_indsC_TeSys_K'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[37]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[38]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[39]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[40]/td/div/text())").get()
            yield {
