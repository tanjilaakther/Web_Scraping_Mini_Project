...
class SeMccbsCompactNsxmSpider(scrapy.Spider):
    name = 'se_mccbs_comPact_NSXM'
    ...
    def parse(self, response):
        ...
        product_height = response.xpath("normalize-space(//div[@class='drawer']/ul/li/section/table[3]/tbody/tr[2]/td/div/text())").get()
        product_width = response.xpath("normalize-space(//div[@class='drawer']/ul/li/section/table[3]/tbody/tr[1]/td/div/text())").get()
        product_depth = response.xpath("normalize-space(//div[@class='drawer']/ul/li/section/table[3]/tbody/tr[3]/td/div/text())").get()
        product_weight = response.xpath("normalize-space(//div[@class='drawer']/ul/li/section/table[3]/tbody/tr[4]/td/div/text())").get()
        yield {
