...
class SeSdfCompactNsxmNaSpider(scrapy.Spider):
    name = 'se_sdf_comPact_NSXM_NA'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[30]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[31]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[32]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[33]/td/div/text())").get()
            yield {
