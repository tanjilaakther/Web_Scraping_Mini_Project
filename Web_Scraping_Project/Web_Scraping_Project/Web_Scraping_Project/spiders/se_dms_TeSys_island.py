...
class SeDmsTesysIslandSpider(scrapy.Spider):
    name = 'se_dms_TeSys_island'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[15]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[14]/td/div/text())").get()
            product_depth = n.xpath("normalize-space(.//tr[16]/td/div/text())").get()
            product_weight = n.xpath("normalize-space(.//tr[17]/td/div/text())").get()
            yield {
