...
class SeSdfCompactInsinvSpider(scrapy.Spider):
    name = 'se_sdf_comPact_insinv'
    ...
    def parse(self, response):
        ...
        for n in characteristics:
            ...
            product_height = n.xpath("normalize-space(.//tr[16]/td/div/text())").get()
            product_width = n.xpath("normalize-space(.//tr[17]/td/div/text())").get()
